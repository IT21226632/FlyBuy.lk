           ...
           <?php include '../../components/admin-nav.php' ?>
            <div class="content">
                ...
                <div class="row add-card ">
                    <form action="../../logic/item/update.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-5 image-col">
                                Item image :
                                <img class="pre-product" id="pre-product" src="../../uploads/items/<?php echo $row["img"]; ?>">
                            ...
                            <div class="col-5">
                                ...
                                <div class="input-row">
                                    ...
                                    <input type="text" class="input" value="<?php echo $row["itemName"]; ?>" name="name" id="name" placeholder="Enter Item name" required>
                                    <span class="error-txt" id="error-name"></span>
                                </div>
                                <div class="input-row">
                                    <label for="price">Item price</label>
                                    <input type="number" min="0" class="input" name="price" value="<?php echo $row["price"]; ?>" id="price" placeholder="Enter Item price" required>
                                    <span class="error-txt" id="error-price"></span>
                                </div>
                                <div class="input-row">
                                    <label for="qty">Item quantity</label>
                                    <input type="number" min="0" class="input" name="qty" value="<?php echo $row["qty"]; ?>" id="qty" placeholder="Enter Item quantity" required>
                                ...
                                <div class="input-row">
                                    ...
                                    <select class="input" name="category" id="category">
                                         <?php
                                            ...
                                            ?>
                                        <option <?php if ($row['category'] == $catrow['categoryName']) echo ' selected="selected"'; ?> value="<?php echo $catrow["categoryName"]; ?>"><?php echo $catrow["categoryName"]; ?></option>
                                         <?php
                                         }
                                    } else {
                                    ?>
                                ...
                                <div class="input-row">
                                    ...
                                    <textarea class="input" name="dec" id="dec" placeholder="Enter Item description" required><?php echo $row["description"]; ?></textarea>
