           ...
           <?php include '../../components/admin-nav.php' ?>
            <div class="content">
                ...
                <div class="row add-card ">
                    <form action="../../logic/category/add.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <div class="input-row">
                                    ...
                                    <input type="text" class="input" name="name" id="name" placeholder="Enter category name" required>
